...
const COLOR = "#38bdf8";                 // sky — legible de lejos
const URL = "https://bycesar.dev";
const LABEL = "niawi ◆ 3 retos en 60 min ◆ bycesar.dev";
